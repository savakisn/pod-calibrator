REMOVAL = {
    ...
    "Disenchant", "Get Lost", "March of Otherworldly Light",
    "Prison Realm", "Skyclave Apparition", "Loran of the Third Path",
    "Solitude", "Out of Time", "Parallax Wave",
    # Blue
    ...
    "Resculpt", "Subtlety", "Cyclonic Rift",
    "Capsize", "Echoing Truth", "Into the Roil",
    # Black
    ...
    "Cut Down", "Power Word Kill", "Bone Shards",
    "Heartless Act", "Baleful Mastery", "Soul Shatter",
    "Grasp of Darkness", "Sheoldred's Edict", "Liliana of the Veil",
    # Red
    "Chaos Warp", "Abrade", "Wild Magic Surge",
    "Kolaghan's Command", "Chaos Defiler",
    "Lightning Bolt", "Roast", "Burst Lightning",
    "Searing Spear", "Galvanic Blast", "Hull Breach",
    "Vandalblast", "Smelt", "By Force",
    "Meltdown", "Shattering Spree", "Shatterstorm",
    # Green
    ...
    "Bramblecrush", "Outland Liberator", "Knight of Autumn",
    "Manglehorn", "Caustic Caterpillar", "Trygon Predator",
    ...
    "Mortify", "Vanishing Verse", "Lightning Helix",
    "Maelstrom Pulse", "Detention Sphere",
    # Land destruction
    "Strip Mine", "Wasteland", "Ghost Quarter",
    "Field of Ruin", "Tectonic Edge", "Demolition Field",
    "Dust Bowl", "Path of Ankrasa", "Encroaching Wastes",
    "Karakas", "Maze of Ith",
    # Graveyard-as-removal / grave hate
    "Scavenging Ooze", "Soul-Guide Lantern", "Tormod's Crypt",
    "Leyline of the Void", "Bojuka Bog", "Endurance",
    "Nihil Spellbomb", "Relic of Progenitus", "Grafdigger's Cage",
    "Rest in Peace", "Cling to Dust",
    # Artifacts
    "Spine of Ish Sah", "Meteor Golem", "Duplicant",
...
BOARD_WIPES = {
    ...
    "Farewell", "Akroma's Vengeance", "Final Judgment",
    "Settle the Wreckage", "Doomskar", "Citizen's Arrest",
    # Black
    ...
    "Drown in Sorrow", "Plague Wind", "Necromantic Selection",
    "Pestilence", "Ritual of Soot", "Yawgmoth's Vile Offering",
    # Red
    ...
    "Brotherhood's End", "Sulfurous Blast", "Pyroclasm",
    "Volcanic Fallout", "Slagstorm",
    # Blue
    "Devastation Tide", "Wash Out", "Cyclonic Rift",
    "Flood of Tears", "Evacuation",
    "Engulf the Shore", "Aetherize", "Crush of Tentacles",
    "River's Rebuke",
    # Green
    "Ezuri's Predation", "Bane of Progress",
    "Hornet Sting", "Squall Line", "Hurricane",
    # Multi
    "Merciless Eviction", "Ruinous Ultimatum", "Depopulate",
    "Casualties of War", "Aetherspouts",
    "Akroma's Will", "Vanquish the Horde", "Cleansing Nova",
    # Artifacts
    "Oblivion Stone", "Nevinyrral's Disk", "Perilous Vault",
    "Ugin, the Spirit Dragon", "All Is Dust",
    "Pernicious Deed", "Engineered Explosives",
}
